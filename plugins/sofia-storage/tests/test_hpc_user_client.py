"""Tests for VUB HPC User API client."""
...
from gpfs.hpc_user_client import VubHpcUserClient


class TestVubHpcUserClient:
    """Test cases for VUB HPC User client."""
    ...
    def hpc_user_client(self, client_config):
        ...
        return VubHpcUserClient(**client_config)

    def test_init(self, client_config):
        """Test client initialization."""
        client = VubHpcUserClient(**client_config)
    ...
    @patch("gpfs.hpc_user_client.httpx.Client")
