"""Tests for VUB GPFS Storage Proxy API."""
...
os.environ["WALDUR_VUB_STORAGE_PROXY_CONFIG_PATH"] = str(test_config_path)
...
class TestStorageProxyAPI:
    ...
    @patch("gpfs.waldur_storage_proxy.main.vub_storage_backend")
    ...
    @patch("gpfs.backend.marketplace_resources_list.sync_detailed")
